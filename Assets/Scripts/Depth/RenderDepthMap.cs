...
namespace SolerSoft.Customization
{
    ...
    public class RenderDepthMap : MonoBehaviour
    {
       ...
       // public UploadTextureAsBMP saveTextureRawDataToVRHeadset;
        ...
        private EnvironmentDepthManager m_depthTextureProvider;
        ...
        private bool TryGetComponents()
        {
            ...
            if (m_depthTextureProvider == null) { m_depthTextureProvider = GetComponent<EnvironmentDepthManager>(); }
        ...
        private bool TryShowTextures()
        {
            ...
            var physicalDepthTex = Shader.GetGlobalTexture("_EnvironmentDepthTexture");
